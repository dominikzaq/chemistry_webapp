 ...
 */
final class Version20210127083315 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE aki_ref (id INT AUTO_INCREMENT NOT NULL, ref VARCHAR(100) NOT NULL, reference VARCHAR(5000) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE fik_ref (id INT AUTO_INCREMENT NOT NULL, ref VARCHAR(100) NOT NULL, reference VARCHAR(5000) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
